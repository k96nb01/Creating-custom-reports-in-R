...
# Libraries we need for this report.
library(tidyverse)
library(RSQLite)
library(kableExtra)
...
Those of you familiar with HTML may notice that this green text here is inside of comment notation. I'm using it here because Quarto will interpret this HTML code as a comment, and will not print it on the final report (even though the final report is a PDF)!
-->
